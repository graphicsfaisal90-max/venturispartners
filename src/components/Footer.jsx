      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div className="footer-col">
            <h4>Our Services</h4>
            <ul>
              <li><Link to="/services/management">Venturis Partners</Link></li>
              <li><Link to="/services/consultancy">Venturis Consultancy</Link></li>
              <li><Link to="/services/venturis-tech">Venturis Tech</Link></li>
              <li><Link to="/services/e-commerce-trading">E-Commerce & Trading</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-col">
            ...
            <ul className="footer-contact">
              <li className="footer-contact-item">
                ...
                <div>
                  <span className="footer-contact-label">Head Office</span><br />
              ...
              <li className="footer-contact-item">
                ...
                <div>
                  <span className="footer-contact-label">US Office</span><br />
                  <span>6501 Arlington Expressway B105 #7330 Jacksonville FL 32211 United States</span>
                </div>
              </li>
              <li className="footer-contact-item footer-contact-item--inline">
                <svg className="footer-contact-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>info@venturispartners.com</span>
              </li>
              <li className="footer-contact-item">
                <svg className="footer-contact-icon footer-contact-icon--mt" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <div className="footer-phones">
                  <a href="tel:+971585318860">+971 58 531 8860</a>
                  <a href="tel:+19046550900">+1 (904) 6550900</a>
                </div>
              </li>
              <li className="footer-contact-item">
                <svg className="footer-contact-icon footer-contact-icon--mt" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <div className="footer-socials">
                    ...
                    <a href="javascript:void(0)" className="footer-social-link" aria-label="Instagram">
                    ...
                    <a href="javascript:void(0)" className="footer-social-link" aria-label="Telegram">
                    ...
                    <a href="javascript:void(0)" className="footer-social-link" aria-label="TikTok">
